...
with open('input_instreamsActive_reqbody.json', 'r') as file:
    request_bodies = json.load(file)

api_url = 'http://192.168.25.189/webapi/v1/settings/instreams'

api_urls_sequence = [
    ('http://192.168.25.189/webapi/v1/settings/instreams/active/0', 'STOP Stream - API URL Start ID 0'),
    ('http://192.168.25.189/webapi/v1/settings/instreams/showpattern/1', 'ID 1 PATTERN change to 1'),
    ('http://192.168.25.189/webapi/v1/settings/instreams/active/1', 'START Stream - API URL Start ID 1'),
    ('http://192.168.25.189/webapi/v1/settings/instreams/active/0', 'STOP Stream - API URL Start ID 0'),
    ('http://192.168.25.189/webapi/v1/settings/instreams/showpattern/1/4', 'ID1 PATTERN change to 4'),    
    ('http://192.168.25.189/webapi/v1/settings/instreams/active/1', 'START Stream - API URL Start ID 1'),
    ('http://192.168.25.189/webapi/v1/settings/instreams/active/0', 'STOP Stream - API URL Start ID 0'),
    ('http://192.168.25.189/webapi/v1/settings/instreams/showpattern/21', 'ID 21 PATTERN change to 1'),
    ('http://192.168.25.189/webapi/v1/settings/instreams/active/21', 'START Stream - API URL Start ID 21'),
    ('http://192.168.25.189/webapi/v1/settings/instreams/active/0', 'STOP Stream - API URL Start ID 0'),
    ('http://192.168.25.189/webapi/v1/settings/instreams/showpattern/21/4', 'ID 21 PATTERN change to 4'),   
    ('http://192.168.25.189/webapi/v1/settings/instreams/active/21', 'START Stream - API URL Start ID 21'),
]
