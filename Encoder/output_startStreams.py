...
with open('startStreams_reqbody.json', 'r') as file:
    request_bodies = json.load(file)

api_url = 'http://192.168.25.90/webapi/v1/settings/outstreams'

api_urls_sequence = [
    ('http://192.168.25.90/webapi/v1/settings/outstreams/startid/0', 'API URL Start ID 0'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/startid/1', 'API URL Start ID 1'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/startid/0', 'API URL Start ID 0'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/startid/11', 'API URL Start ID 11'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/startid/0', 'API URL Start ID 0'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/startid/21', 'API URL Start ID 21'),
]
