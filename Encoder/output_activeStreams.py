...
with open('activeStreams_reqbody.json', 'r') as file:
    request_bodies = json.load(file)

api_url = 'http://192.168.25.90/webapi/v1/settings/outstreams'

api_urls_sequence = [
    ('http://192.168.25.90/webapi/v1/settings/outstreams/active/0', 'STOP Stream - API URL Start ID 0'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/active/22', 'START Stream - API URL Start ID 22'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/active/0', 'STOP Stream - API URL Start ID 0'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/active/11', 'START Stream - API URL Start ID 11'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/active/0', 'STOP Stream - API URL Start ID 0'),
    ('http://192.168.25.90/webapi/v1/settings/outstreams/active/21', 'START Stream - API URL Start ID 21'),
]
